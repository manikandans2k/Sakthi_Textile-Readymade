...
const REFRESH_SECRET = process.env.REFRESH_SECRET && process.env.REFRESH_SECRET.length >= 64
  ? process.env.REFRESH_SECRET
  : (process.env.NODE_ENV === 'production' 
      ? (() => { throw new Error('CRITICAL CONFIGURATION ERROR: process.env.REFRESH_SECRET must be set in production with at least 64 characters!'); })()
      : 'super_secret_textile_pos_refresh_key_2026_default_development_key_minimum_64_characters_long_string_for_testing');
